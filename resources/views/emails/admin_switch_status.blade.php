					...
					<tr>
						<td style="width: 800px; background: #ffffff;">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 30px 10px 0 10px;">Hi Admin,</td>
								</tr>
								<tr>
									<td style="padding: 10px;">{!! title_case($data->name) !!} has been selected in  {!! title_case($data->department->name) !!} department.</td>
								</tr>
								<tr>
